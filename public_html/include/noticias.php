<?php
  ...
  $url = 'http://'.$domain.'/admin/routes/ultima_noticia.php';
  $json = obtener($url);
...
<div class="tarjeta-noticias">
  ...
  <div class="row" style="padding:25px;">
    <div class="col-lg-6">
      <h4><a href="single_noticias.php?id=<?php echo $obj->id; ?>"><?php echo $obj->titulo; ?></a></h4>
    </div>
    <div class="col-lg-6">
    ...
    <div class="smallt">
      <ul class="list-unstyled list-inline list-social-icons" style="margin-left: 10px;">
        <li style="vertical-align: super;">
          <div class="fb-like" data-href="<?php echo '/single_noticias.php?id='.$obj->id;?>" data-layout="button_count" data-action="like" data-size="small" data-show-faces="true" data-share="true"></div>
        </li>
        <li>
